...
class OfferDetailViewController: UIViewController {
    ...
    static func instantiateViewController(offer: OfferRequireMatchedItem, parent: MainViewController) -> UINavigationController {
        ...
        let viewController = storyboard.instantiateViewController(withIdentifier: "STNavigationController") as! UINavigationController
        let root = viewController.viewControllers.first as! OfferDetailViewController
        root.offer = offer
...
extension OfferDetailViewController: UITableViewDelegate {
...
extension OfferDetailViewController: DoubleButtonCellDelegate {
